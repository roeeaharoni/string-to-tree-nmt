...
dev_target=$base_path/git/research/nmt/models/$model_name/newstest2015-deen.tok.penntrg.clean.true.bpe.de.output.sents.dev.postprocessed

dev_trees=$base_path/git/research/nmt/models/$model_name/newstest2015-deen.tok.penntrg.clean.true.bpe.de.output.trees.dev
