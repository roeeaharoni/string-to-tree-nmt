...
def main():
    ...
    model_prefix = base_path + '/git/research/nmt/models/en_de_tts/en_de_tts_model.npz.npz.best_bleu'

    dev_src = base_path + '/git/research/nmt/data/WMT16/de-en/dev/newstest2015-deen-ref.tok.true.parsed.en.bped'

    dev_target = base_path + '/git/research/nmt/models/en_de_tts/newstest2015-deen-ref.tok.true.parsed.en.bped.output.dev.best'

    alignments_path = base_path + '/git/research/nmt/models/en_de_tts/best_dev_alignmnets.txt'
    ...
    postprocess_command = '../postprocess-dev.sh < {} > {}.postprocessed'.format(dev_target, dev_target)
