...
# model prefix
model_prefix=$base_path/git/research/nmt/models/de_en_stt_v8/de_en_stt_v8_model.npz

# dev ref file
ref=$base_path/git/research/nmt/data/news-de-en/dev/newstest2015-deen.en

dev_target=$base_path/git/research/nmt/models/de_en_stt_v8/newstest2015-deen.tok.penntrg.clean.true.bpe.de.output.sents.dev.postprocessed

dev_trees=$base_path/git/research/nmt/models/de_en_stt_v8/newstest2015-deen.tok.penntrg.clean.true.bpe.de.output.trees.dev

dev_alignments=$base_path/git/research/nmt/models/de_en_stt_v8/dev_alignments.txt
