...
dev_trees=$base_path/git/research/nmt/models/de_en_stt/newstest2015-deen-src.tok.true.de.bpe.output.trees.dev

dev_alignments=$base_path/git/research/nmt/models/de_en_stt/dev_alignments.txt
