...
def main():
    ...
    src_2015 = base_path + '/git/research/nmt/data/news-de-en-50/dev/newstest2015-deen.tok.penntrg.clean.true.bpe.de'
    ...
    src_2016 = base_path + '/git/research/nmt/data/news-de-en-50/test/newstest2016-deen.tok.penntrg.clean.true.bpe.de'
