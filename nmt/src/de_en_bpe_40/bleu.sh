...
dev_target=$base_path/git/research/nmt/models/de_en_bpe_40/newstest2015-deen-src.tok.true.de.bpe.output.dev.postprocessed

dev_alignments=$base_path/git/research/nmt/models/de_en_bpe_40/dev_alignments.txt
