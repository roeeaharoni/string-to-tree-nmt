...
def main():
    ...
    dev_src = base_path + '/git/research/nmt/data/news-cs-en/dev/newstest2015-csen.tok.penntrg.clean.true.bpe.cs'

    dev_target = base_path + '/git/research/nmt/models/{}/newstest2015-csen.tok.penntrg.clean.true.bpe.cs.output.trees.dev'.format(model_name)

    dev_target_sents = base_path + '/git/research/nmt/models/{}/newstest2015-csen.tok.penntrg.clean.true.bpe.cs.output.sents.dev'.format(model_name)
    ...
    moses_path = base_path + '/git/mosesdecoder/'
    src_sgm_path = base_path + '/git/research/nmt/data/news-cs-en/dev/newstest2015-csen-src.cs.sgm'
    ref_sgm_path = base_path + '/git/research/nmt/data/news-cs-en/dev/newstest2015-csen-ref.en.sgm'
