...
--datasets $base_path/git/research/nmt/data/news-cs-en/train/news-commentary-v8.cs-en.tok.penntrg.clean.true.bpe.cs.copy \
           $base_path/git/research/nmt/data/news-cs-en/train/news-commentary-v8.cs-en.tok.penntrg.clean.true.desc.parsed.linear.bpe.en \
--dictionaries $base_path/git/research/nmt/data/news-cs-en/train/news-commentary-v8.cs-en.tok.penntrg.clean.true.bpe.cs.json \
               $base_path/git/research/nmt/data/news-cs-en/train/news-commentary-v8.cs-en.tok.penntrg.clean.true.desc.parsed.linear.bpe.en.json \
...
--valid_datasets $base_path/git/research/nmt/data/news-cs-en/dev/newstest2015-csen.tok.penntrg.clean.true.bpe.cs \
                 $base_path/git/research/nmt/data/news-cs-en/dev/newstest2015-csen.tok.penntrg.clean.true.desc.parsed.linear.bpe.en \
