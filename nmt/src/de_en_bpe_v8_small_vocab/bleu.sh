...
# model prefix
model_prefix=$base_path/git/research/nmt/models/de_en_bpe_v8_small_vocab/de_en_bpe_v8_small_vocab_model.npz

# dev ref file
ref=$base_path/git/research/nmt/data/news-de-en/dev/newstest2015-deen.en

# dev predictions file
dev_target=$base_path/git/research/nmt/models/de_en_bpe_v8_small_vocab/newstest2015-deen.tok.penntrg.clean.true.bpe.de.output.dev.postprocessed

# dev alignments file
dev_alignments=$base_path/git/research/nmt/models/de_en_bpe_v8_small_vocab/dev_alignments.txt
