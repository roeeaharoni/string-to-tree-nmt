...
def main():
    ...
    model_name = 'de_en_stt_v8_small_vocab_drop_tied'
    ...
    ensemble_models_path = [
        base_path + '/git/research/nmt/models/{}/{}_model.iter50000.npz'.format(model_name,model_name),
    ...
    src_2015 = base_path + '/git/research/nmt/data/news-de-en/dev/small_vocab/newstest2015-deen.tok.penntrg.clean.true.bpe.de'
    trg_2015_trees = base_path + '/git/research/nmt/models/{}/newstest2015-deen.tok.penntrg.clean.true.bpe.de.output.trees.en'.format(model_name)
    trg_2015_sents = base_path + '/git/research/nmt/models/{}/newstest2015-deen.tok.penntrg.clean.true.bpe.de.output.sents.en'.format(model_name)
    align_2015 = base_path + '/git/research/nmt/models/{}/newstest2015-deen.tok.penntrg.clean.true.bpe.de.output.en.alignments.txt'.format(model_name)
    valid_trees_log_2015 = trg_2015_trees + '_validtrees.txt'

    src_2016 = base_path + '/git/research/nmt/data/news-de-en/test/small_vocab/newstest2016-deen.tok.penntrg.clean.true.bpe.de'
