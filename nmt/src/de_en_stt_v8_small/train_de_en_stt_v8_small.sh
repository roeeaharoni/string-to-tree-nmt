...
--datasets $base_path/git/research/nmt/data/news-de-en/train/news-commentary-v8.de-en.tok.penntrg.clean.true.bpe.de.copy \
...
--model $base_path/git/research/nmt/models/de_en_stt_v8_small/de_en_stt_v8_small_model.npz \
--saveFreq 10000 \
--validFreq 5000 \
--dim_word 256 \
--dim 256 \
...
--external_validation_script $base_path/git/research/nmt/src/de_en_stt_v8_small/validate_trees.sh \
--optimizer adadelta \
--lrate 0.0001 \
--alpha_c 0.0 \
--clip_c 1.0 \
