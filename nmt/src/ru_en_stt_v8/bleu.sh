...
# dev ref file
ref=$base_path/git/research/nmt/data/news-ru-en/dev/newstest2015-ruen.en

dev_target=$base_path/git/research/nmt/models/$model_name/newstest2015-ruen.tok.penntrg.clean.true.bpe.ru.output.sents.dev.postprocessed

dev_trees=$base_path/git/research/nmt/models/$model_name/newstest2015-ruen.tok.penntrg.clean.true.bpe.ru.output.trees.dev
