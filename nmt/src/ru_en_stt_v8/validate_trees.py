...
def main():
    ...
    dev_src = base_path + '/git/research/nmt/data/news-ru-en/dev/newstest2015-ruen.tok.penntrg.clean.true.bpe.ru'

    dev_target = base_path + '/git/research/nmt/models/{}/newstest2015-ruen.tok.penntrg.clean.true.bpe.ru.output.trees.dev'.format(model_name)

    dev_target_sents = base_path + '/git/research/nmt/models/{}/newstest2015-ruen.tok.penntrg.clean.true.bpe.ru.output.sents.dev'.format(model_name)
    ...
    moses_path = base_path + '/git/mosesdecoder/'
    src_sgm_path = base_path + '/git/research/nmt/data/news-ru-en/dev/newstest2015-ruen-src.ru.sgm'
    ref_sgm_path = base_path + '/git/research/nmt/data/news-ru-en/dev/newstest2015-ruen-ref.en.sgm'
