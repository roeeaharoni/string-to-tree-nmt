...
def main():
    ...
    trg_2015 = base_path + '/git/research/nmt/models/{}/newstest2015-csen.tok.penntrg.clean.true.bpe.cs.output.en'.format(model_name)
    ...
    src_2016 = base_path + '/git/research/nmt/data/news-cs-en/test/newstest2016-csen.tok.penntrg.clean.true.bpe.cs'
    trg_2016 = base_path + '/git/research/nmt/models/{}/newstest2016-csen.tok.penntrg.clean.true.bpe.cs.output.en'.format(model_name)
