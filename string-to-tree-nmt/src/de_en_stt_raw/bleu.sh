...
dev_target=$base_path/git/research/nmt/models/de_en_stt_raw/newstest-2013-2014-deen.tok.penntrg.clean.true.bpe.de.output.sents.dev.postprocessed

dev_trees=$base_path/git/research/nmt/models/de_en_stt_raw/newstest-2013-2014-deen.tok.penntrg.clean.true.bpe.de.output.trees.dev

dev_alignments=$base_path/git/research/nmt/models/de_en_stt_raw/dev_alignments.txt
