...
# model prefix
model_prefix=$base_path/git/research/nmt/models/de_en_bpe/de_en_bpe_model.npz

# dev ref file
ref=$base_path/git/research/nmt/data/WMT16/de-en/dev/newstest2015-deen-ref.en

# dev predictions file
dev_target=$base_path/git/research/nmt/models/de_en_bpe/newstest2015-deen-src.tok.true.de.bpe.output.dev.postprocessed

dev_alignments=$base_path/git/research/nmt/models/de_en_bpe/dev_alignments.txt
