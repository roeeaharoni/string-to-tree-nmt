...
--datasets $base_path/git/research/nmt/data/news-ru-en/train/news-commentary-v8.ru-en.tok.penntrg.clean.true.bpe.ru \
           $base_path/git/research/nmt/data/news-ru-en/train/news-commentary-v8.ru-en.tok.penntrg.clean.true.bpe.en \
--dictionaries $base_path/git/research/nmt/data/news-ru-en/train/news-commentary-v8.ru-en.tok.penntrg.clean.true.bpe.ru.json \
               $base_path/git/research/nmt/data/news-ru-en/train/news-commentary-v8.ru-en.tok.penntrg.clean.true.bpe.en.json \
...
--valid_datasets $base_path/git/research/nmt/data/news-ru-en/dev/newstest2015-ruen.tok.penntrg.clean.true.bpe.ru \
                 $base_path/git/research/nmt/data/news-ru-en/dev/newstest2015-ruen.tok.penntrg.clean.true.bpe.en \
