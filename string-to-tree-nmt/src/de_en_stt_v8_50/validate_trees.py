...
def main():
    ...
    dev_src = base_path + '/git/research/nmt/data/news-de-en-50/dev/newstest2015-deen.tok.penntrg.clean.true.bpe.de'
    ...
    moses_path = base_path + '/git/mosesdecoder/'
    src_sgm_path = base_path + '/git/research/nmt/data/news-de-en-50/dev/newstest2015-deen-src.de.sgm'
    ref_sgm_path = base_path + '/git/research/nmt/data/news-de-en-50/dev/newstest2015-deen-ref.en.sgm'
