...
# dev ref file
ref=$base_path/git/research/nmt/data/news-cs-en/dev/newstest2015-csen.en

dev_target=$base_path/git/research/nmt/models/$model_name/newstest2015-csen.tok.penntrg.clean.true.bpe.cs.output.sents.dev.postprocessed

dev_trees=$base_path/git/research/nmt/models/$model_name/newstest2015-csen.tok.penntrg.clean.true.bpe.cs.output.trees.dev
